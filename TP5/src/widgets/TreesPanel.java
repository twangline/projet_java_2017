		...
		if ((drawing != null) && (tree != null))
		{
			switch (this.treeType)
			{
				case FIGURE:
					...
					break;
				case FIGURE_TYPE:
					model = null; // TODO new FigureTypeTreeModel(drawing, tree);
					break;
				case FILL_COLOR:
					model = null; // TODO new FillColorTreeModel(drawing, tree);
					break;
				case EDGE_COLOR:
					model = null; // TODO new EdgeColorTreeModel(drawing, tree);
					break;
				case EDGE_TYPE:
					model = null; // TODO new EdgeTypeTreeModel(drawing, tree);
					break;
				default:
					model = null;
					break;
